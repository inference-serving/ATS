...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["mvit"]
...
_C.DATA.PATH_TO_DATA_DIR = "/media/datasets/ILSVRC/"
...
# Output basedir.
_C.OUTPUT_DIR = "/home/cc/ATS/ATS-ViT/output"
...
# Aligned version of RoI. More details can be found at libs/models/head_helper.py
...
_C.VIT.IN_CHANNELS = 3
_C.VIT.NUM_CLASSES = 1000
_C.VIT.EMBED_DIM = 384
_C.VIT.DEPTH = 12
_C.VIT.NUM_HEADS = 6
_C.VIT.MLP_RATIO = 4.0
_C.VIT.QKV_BIAS = True
_C.VIT.QK_SCALE = None
_C.VIT.REPRESENTATION_SIZE = None
_C.VIT.DROP_RATE = 0.0
_C.VIT.ATTN_DROP_RATE = 0.0
_C.VIT.DROP_PATH_RATE = 0.0
_C.VIT.HYBRID_BACKBONE = None
_C.VIT.NORM_LAYER = None
_C.VIT.ATS_BLOCKS = [3, 4, 5, 6, 7, 8, 9, 10, 11]
_C.VIT.NUM_TOKENS = [197, 197, 197, 197, 197, 197, 197, 197, 197, 197, 197, 197]
_C.VIT.DROP_TOKENS = False
